...
//       <div className="Top-Restaurants">
//         <div className="slider-arrow">
//           <p className='arrow' onClick={prevslide}><FaArrowLeft /></p>
//           <p className='arrow' onClick={nextslide}><FaArrowRight /></p>
//         </div>
//         <div className="Top-Restaurants-cards">
//           {listofTopRestaurant.map((restaurant, index) => (
//             <div key={index} className='top-cards shrink-0 duration-500' style={{ transform: `translateX(${slide}px)` }}>
